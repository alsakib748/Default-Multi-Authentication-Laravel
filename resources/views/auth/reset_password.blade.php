        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <form class="form-horizontal mt-3" action="{{ route('reset.password.submit') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control" type="password" name="new_retype_password"
                                        required="" placeholder="New Confirm Password">
                                </div>
                            </div>
